...
public abstract class CharacterEncoding {
	...
	// static loading
	private static final HashMap<String, CharacterEncoding> ENCODING_HASH = new HashMap<String, CharacterEncoding>();
	...
	private static final String[] UTF_8_ALIASES = { CANONICAL_UTF_8_NAME,
			"UTF-8" };
	private static final String[] SHIFT_JIS_ALIASES = {
			CANONICAL_SHIFT_JIS_NAME, "SHIFTJIS", "SHIFT-JIS", "SHIFT_JIS" };
	...
	/*
	 * Returns the official IANA name for the encoding. Everything expect Java
	 * expects this form.
	 */
